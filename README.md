Реализация админ панели с помощью PHP и JavaScript. В проекте использовался процедурный подход и ООП подход. Работа создавалась в команде из двух человек.
