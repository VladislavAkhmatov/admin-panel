        ...
        <div class="col-xs-12">
            <div class="box">
                <section class="content-header">
                    <h3><b>
                            <?= $header = isset($_GET['message']) ? Helper::message($_GET['message']) : 'Список учителей' ?>
                        </b></h3>
                    <ol class="breadcrumb">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            foreach ($teachers as $teacher) {
                                ...
                                if (!Helper::can('teacher')):
                                    echo '<td><a href="../profile/profile-teacher?id=' . $teacher->user_id . '">' . $teacher->fio . '</a> ' . '<a href="../add/add-teacher?k=teacher&id=' . $teacher->user_id . '"><i class="fa fa-pencil"></i></a> <a href="../delete/delete-teacher?id=' . $teacher->user_id . '"><i class="fa fa-times"></i></a></td>';
                                else:
