...
(19, 'Дроздов', 'Арсений', 'Михайлович', 'manager@local.kz', '$2y$10$/7oNN.YXdskRMpeRJAPqZuRHJqsrsUV.XHVnJia9/JzthZqhYL4Sq', 1, '1997-07-12', 3, 1, '1713332735_images.jpg', 0),
...
(113, 'uchitel', 'uchitel', 'uchitel', 'uchitel', '$2y$10$OQ28T5QSPNGV8XLVfgu/o.Cq/g27GI07Tc8wIlO/dqjDNCHOB1PyC', 1, '2024-04-19', 4, 1, 'default.png', 0),
(114, 'roditel', 'roditel', 'roditel', 'roditel@local.kz', '$2y$10$KxGRrohmIa8g96AuImC97.aA0Q6eMt080oTDyqxZ/cB7mn9Q0Wcpy', 1, '2024-04-18', 6, 1, 'default.png', 0),
(115, 'sadaljshdnas', 'fkgjdegklfdngh', 'lkjdfgklfdng', 'test@mail.ru', '$2y$10$q.uzAAxtTZQBrDJ.v5gWveGgpXJXMDgiAtvh39Ih.UFHmSZhaR.4O', 1, '2024-04-01', 6, 1, 'default.png', 0),
(116, 'manager12345', 'manager12345', 'manager12345', 'manager12345@mail.ru', '$2y$10$ZmD9D6bjU0uTk.ys/zCs5.SPh5C2J/KDYMw47e.9IyvxNYRd5tqiS', 1, '2024-05-01', 3, 1, 'default.png', 0),
(117, 'uchitel', 'uchitel', 'uchitel', 'uchitel@local.ru', '$2y$10$LOsSTvoRhCg3Z35wOEHdEu0gAGE5ITKWGo3uoMW1I3aoauGbL504m', 1, '2024-05-01', 4, 1, 'default.png', 0),
(118, 'uchitel', 'uchitel', 'uchitel', 'uchitel@local.kz', '$2y$10$UqIBrXGgSAWK5rbILrzGyO2pRyXqV4.OOa/ZIZmI9eqPEJ.09jvwG', 1, '2024-04-01', 4, 1, 'default.png', 0);
...
--
ALTER TABLE `user`
  MODIFY `user_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
